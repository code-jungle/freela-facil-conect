-- Adicionar nova coluna para tipos múltiplos
ALTER TABLE public.profiles 
ADD COLUMN tipos_profissional text[] DEFAULT ARRAY['freelancer'];

-- Migrar dados existentes
UPDATE public.profiles 
SET tipos_profissional = ARRAY[tipo_profissional];

-- Remover coluna antiga
ALTER TABLE public.profiles 
DROP COLUMN tipo_profissional;

-- Renomear nova coluna
ALTER TABLE public.profiles 
RENAME COLUMN tipos_profissional TO tipo_profissional;

-- Tornar coluna obrigatória
ALTER TABLE public.profiles 
ALTER COLUMN tipo_profissional SET NOT NULL;
